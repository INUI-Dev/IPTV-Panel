...
class Google_Service_Fitness extends Google_Service
{
  ...
  public $users_db_db_dataSources;
  public $users_db_db_dataSources_datasets;
  public $users_db_db_sessions;
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->servicePath = 'fitness/v1/users_db_db/';
    $this->version = 'v1';
    $this->serviceName = 'fitness';

    $this->users_db_db_dataSources = new Google_Service_Fitness_users_db_dbDataSources_Resource(
        $this,
        $this->serviceName,
        'dataSources',
        array(
    ...
    $this->users_db_db_dataSources_datasets = new Google_Service_Fitness_users_db_dbDataSourcesDatasets_Resource(
        $this,
        $this->serviceName,
        'datasets',
        array(
    ...
    $this->users_db_db_sessions = new Google_Service_Fitness_users_db_dbSessions_Resource(
        $this,
        $this->serviceName,
        'sessions',
        array(
 ...
 *   $users_db_db = $fitnessService->users_db_db;
 *  </code>
 */
class Google_Service_Fitness_users_db_db_Resource extends Google_Service_Resource
{
}
 ...
 *  </code>
 */
class Google_Service_Fitness_users_db_dbDataSources_Resource extends Google_Service_Resource
{
   ...
   * scopes. (dataSources.listusers_db_dbDataSources)
   *
   ...
   */
  public function listusers_db_dbDataSources($userId, $optParams = array())
  {
 ...
 *  </code>
 */
class Google_Service_Fitness_users_db_dbDataSourcesDatasets_Resource extends Google_Service_Resource
{
 ...
 *  </code>
 */
class Google_Service_Fitness_users_db_dbSessions_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists sessions previously created. (sessions.listusers_db_dbSessions)
   *
   ...
   */
  public function listusers_db_dbSessions($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
