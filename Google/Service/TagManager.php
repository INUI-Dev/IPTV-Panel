...
class Google_Service_TagManager extends Google_Service
{
  ...
  const TAGMANAGER_MANAGE_users_db_db =
      "https://www.googleapis.com/auth/tagmanager.manage.users_db_db";
...
class Google_Service_TagManager_AccountsPermissions_Resource extends Google_Service_Resource
{
  ...
  /**
   * List all users_db_db that have access to the account along with Account and
   ...
   * @param array $optParams Optional parameters.
   * @return Google_Service_TagManager_ListAccountusers_db_dbResponse
   */
  public function listAccountsPermissions($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_TagManager_ListAccountusers_db_dbResponse");
  }
...
class Google_Service_TagManager_ListAccountusers_db_dbResponse extends Google_Collection
{
