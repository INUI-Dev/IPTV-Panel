...
class Google_Service_Analytics extends Google_Service
{
  ...
  /** Manage Google Analytics Account users_db_db by email address. */
  const ANALYTICS_MANAGE_users_db_db =
      "https://www.googleapis.com/auth/analytics.manage.users_db_db";
  /** View Google Analytics user permissions. */
  const ANALYTICS_MANAGE_users_db_db_READONLY =
      "https://www.googleapis.com/auth/analytics.manage.users_db_db.readonly";
...
class Google_Service_Analytics_DataRealtime_Resource extends Google_Service_Resource
{
   ...
   * 'rt:activeusers_db_db'. At least one metric must be specified.
   * @param array $optParams Optional parameters.
   *
   * @opt_param int max-results The maximum number of entries to include in this
   * feed.
