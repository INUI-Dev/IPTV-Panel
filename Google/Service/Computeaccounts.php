...
class Google_Service_Computeaccounts extends Google_Service
{
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->users_db_db = new Google_Service_Computeaccounts_users_db_db_Resource(
        $this,
        $this->serviceName,
        'users_db_db',
        array(
          'methods' => array(
            'addPublicKey' => array(
              'path' => '{project}/global/users_db_db/{user}/addPublicKey',
              'httpMethod' => 'POST',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
              ...
              'path' => '{project}/global/users_db_db/{user}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
              ...
              'path' => '{project}/global/users_db_db',
              'httpMethod' => 'POST',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
              ...
              'path' => '{project}/global/users_db_db/{user}/removePublicKey',
              'httpMethod' => 'POST',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
...
class Google_Service_Computeaccounts_Groups_Resource extends Google_Service_Resource
{
  ...
  /**
   * Adds users_db_db to the specified group. (groups.addMember)
   *
   * @param string $project Project ID for this request.
  ...
  /**
   * Removes users_db_db from the specified group. (groups.removeMember)
   *
   * @param string $project Project ID for this request.
   * @param string $groupName Name of the group for this request.
 ...
 *  <code>
 *   $computeaccountsService = new Google_Service_Computeaccounts(...);
 *   $users_db_db = $computeaccountsService->users_db_db;
 *  </code>
 */
class Google_Service_Computeaccounts_users_db_db_Resource extends Google_Service_Resource
{

  /**
   * Adds a public key to the specified user using the data included in the
   * request. (users_db_db.addPublicKey)
   *
   * @param string $project Project ID for this request.
  ...
  /**
   * Deletes the specified user resource. (users_db_db.delete)
   *
   * @param string $project Project ID for this request.
  ...
  /**
   * Returns the specified user resource. (users_db_db.get)
   *
   * @param string $project Project ID for this request.
   ...
   * the request. (users_db_db.insert)
   *
   * @param string $project Project ID for this request.
  ...
  /**
   * Retrieves the list of users_db_db contained within the specified project.
   ...
   */
  public function listusers_db_db($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
  ...
  /**
   * Removes the specified public key from the user. (users_db_db.removePublicKey)
   *
   * @param string $project Project ID for this request.
   * @param string $user Name of the user for this request.
