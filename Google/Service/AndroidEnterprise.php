...
class Google_Service_AndroidEnterprise extends Google_Service
{
  ...
  public $grouplicenseusers_db_db;
  public $installs;
  public $permissions;
  public $products;
  public $users_db_db;
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->collectionviewers = new Google_Service_AndroidEnterprise_Collectionviewers_Resource(
        ...
        array(
          'methods' => array(
            'delete' => array(
              'path' => 'enterprises/{enterpriseId}/collections/{collectionId}/users_db_db/{userId}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
              ...
              'path' => 'enterprises/{enterpriseId}/collections/{collectionId}/users_db_db',
              'httpMethod' => 'GET',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
    ...
    $this->devices = new Google_Service_AndroidEnterprise_Devices_Resource(
        ...
        array(
          'methods' => array(
            'get' => array(
              'path' => 'enterprises/{enterpriseId}/users_db_db/{userId}/devices/{deviceId}',
              'httpMethod' => 'GET',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
              ...
              'path' => 'enterprises/{enterpriseId}/users_db_db/{userId}/devices/{deviceId}/state',
              'httpMethod' => 'GET',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
              ...
              'path' => 'enterprises/{enterpriseId}/users_db_db/{userId}/devices',
              'httpMethod' => 'GET',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
    ...
    $this->entitlements = new Google_Service_AndroidEnterprise_Entitlements_Resource(
        ...
        array(
          'methods' => array(
            'delete' => array(
              'path' => 'enterprises/{enterpriseId}/users_db_db/{userId}/entitlements/{entitlementId}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
              ...
              'path' => 'enterprises/{enterpriseId}/users_db_db/{userId}/entitlements',
              'httpMethod' => 'GET',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
    ...
    $this->grouplicenseusers_db_db = new Google_Service_AndroidEnterprise_Grouplicenseusers_db_db_Resource(
        $this,
        $this->serviceName,
        'grouplicenseusers_db_db',
        array(
          'methods' => array(
            'list' => array(
              'path' => 'enterprises/{enterpriseId}/groupLicenses/{groupLicenseId}/users_db_db',
              'httpMethod' => 'GET',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
    ...
    $this->installs = new Google_Service_AndroidEnterprise_Installs_Resource(
        ...
        array(
          'methods' => array(
            'delete' => array(
              'path' => 'enterprises/{enterpriseId}/users_db_db/{userId}/devices/{deviceId}/installs/{installId}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
              ...
              'path' => 'enterprises/{enterpriseId}/users_db_db/{userId}/devices/{deviceId}/installs',
              'httpMethod' => 'GET',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
    ...
    $this->users_db_db = new Google_Service_AndroidEnterprise_users_db_db_Resource(
        $this,
        $this->serviceName,
        'users_db_db',
        array(
          'methods' => array(
            'generateToken' => array(
              'path' => 'enterprises/{enterpriseId}/users_db_db/{userId}/token',
              'httpMethod' => 'POST',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
              ...
              'path' => 'enterprises/{enterpriseId}/users_db_db/{userId}',
              'httpMethod' => 'GET',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
              ...
              'path' => 'enterprises/{enterpriseId}/users_db_db',
              'httpMethod' => 'GET',
              'parameters' => array(
                'enterpriseId' => array(
                  'location' => 'path',
...
class Google_Service_AndroidEnterprise_Collectionviewers_Resource extends Google_Service_Resource
{
   ...
   * such users_db_db will see the collection. (collectionviewers.delete)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $collectionId The ID of the collection.
   ...
   * only these users_db_db will see the collection. (collectionviewers.get)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $collectionId The ID of the collection.
   * @param string $userId The ID of the user.
  ...
  /**
   * Retrieves the IDs of the users_db_db who have been specifically allowed to see the
   * collection. If the collection's visibility is set to viewersOnly then only
   * these users_db_db will see the collection.
   ...
   * collection. If the collection's visibility is set to viewersOnly then only
   * such users_db_db will see the collection. This method supports patch semantics.
   ...
   * Adds the user to the list of those specifically allowed to see the
   * collection. If the collection's visibility is set to viewersOnly then only
   * such users_db_db will see the collection. (collectionviewers.update)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $collectionId The ID of the collection.
   * @param string $userId The ID of the user.
...
/**
 * The "grouplicenseusers_db_db" collection of methods.
 * Typical usage is:
 *  <code>
 *   $androidenterpriseService = new Google_Service_AndroidEnterprise(...);
 *   $grouplicenseusers_db_db = $androidenterpriseService->grouplicenseusers_db_db;
 *  </code>
 */
class Google_Service_AndroidEnterprise_Grouplicenseusers_db_db_Resource extends Google_Service_Resource
{

  /**
   * Retrieves the IDs of the users_db_db who have been granted entitlements under the
   * license. (grouplicenseusers_db_db.listGrouplicenseusers_db_db)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $groupLicenseId The ID of the product the group license is for,
   * e.g. "app:com.google.android.gm".
   * @param array $optParams Optional parameters.
   * @return Google_Service_AndroidEnterprise_GroupLicenseusers_db_dbListResponse
   */
  public function listGrouplicenseusers_db_db($enterpriseId, $groupLicenseId, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'groupLicenseId' => $groupLicenseId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_AndroidEnterprise_GroupLicenseusers_db_dbListResponse");
  }
}
 ...
 *  <code>
 *   $androidenterpriseService = new Google_Service_AndroidEnterprise(...);
 *   $users_db_db = $androidenterpriseService->users_db_db;
 *  </code>
 */
class Google_Service_AndroidEnterprise_users_db_db_Resource extends Google_Service_Resource
{
   ...
   * token. (users_db_db.generateToken)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $userId The ID of the user.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Retrieves a user's details. (users_db_db.get)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $userId The ID of the user.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Looks up a user by email address. (users_db_db.listusers_db_db)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $email The exact primary email address of the user to look up.
   * @param array $optParams Optional parameters.
   * @return Google_Service_AndroidEnterprise_users_db_dbListResponse
   */
  public function listusers_db_db($enterpriseId, $email, $optParams = array())
  {
    $params = array('enterpriseId' => $enterpriseId, 'email' => $email);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_AndroidEnterprise_users_db_dbListResponse");
  }

  /**
   * Revokes a previously generated token (activation code) for the user.
   * (users_db_db.revokeToken)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $userId The ID of the user.
   * @param array $optParams Optional parameters.
...
class Google_Service_AndroidEnterprise_GroupLicenseusers_db_dbListResponse extends Google_Collection
{
  protected $collection_key = 'user';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_AndroidEnterprise_users_db_dbListResponse extends Google_Collection
{
  protected $collection_key = 'user';
  protected $internal_gapi_mappings = array(
  );
