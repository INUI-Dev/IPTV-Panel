...
class Google_Service_SQLAdmin extends Google_Service
{
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->users_db_db = new Google_Service_SQLAdmin_users_db_db_Resource(
        $this,
        $this->serviceName,
        'users_db_db',
        array(
          'methods' => array(
            'delete' => array(
              'path' => 'projects/{project}/instances/{instance}/users_db_db',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
 ...
 *  <code>
 *   $sqladminService = new Google_Service_SQLAdmin(...);
 *   $users_db_db = $sqladminService->users_db_db;
 *  </code>
 */
class Google_Service_SQLAdmin_users_db_db_Resource extends Google_Service_Resource
{

  /**
   * Deletes a user from a Cloud SQL instance. (users_db_db.delete)
   *
   * @param string $project Project ID of the project that contains the instance.
   * @param string $instance Database instance ID. This does not include the
   * project ID.
  ...
  /**
   * Creates a new user in a Cloud SQL instance. (users_db_db.insert)
   *
   * @param string $project Project ID of the project that contains the instance.
   * @param string $instance Database instance ID. This does not include the
   * project ID.
  ...
  /**
   * Lists users_db_db in the specified Cloud SQL instance. (users_db_db.listusers_db_db)
   *
   * @param string $project Project ID of the project that contains the instance.
   * @param string $instance Database instance ID. This does not include the
   * project ID.
   * @param array $optParams Optional parameters.
   * @return Google_Service_SQLAdmin_users_db_dbListResponse
   */
  public function listusers_db_db($project, $instance, $optParams = array())
  {
    $params = array('project' => $project, 'instance' => $instance);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_SQLAdmin_users_db_dbListResponse");
  }

  /**
   * Updates an existing user in a Cloud SQL instance. (users_db_db.update)
   *
   * @param string $project Project ID of the project that contains the instance.
   * @param string $instance Database instance ID. This does not include the
   * project ID.
...
class Google_Service_SQLAdmin_users_db_dbListResponse extends Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
