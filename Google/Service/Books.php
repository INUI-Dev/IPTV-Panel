  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->bookshelves = new Google_Service_Books_Bookshelves_Resource(
        ...
        array(
          'methods' => array(
            'get' => array(
              'path' => 'users_db_db/{userId}/bookshelves/{shelf}',
              'httpMethod' => 'GET',
              'parameters' => array(
                'userId' => array(
                  'location' => 'path',
              ...
              'path' => 'users_db_db/{userId}/bookshelves',
              'httpMethod' => 'GET',
              'parameters' => array(
                'userId' => array(
                  'location' => 'path',
    ...
    $this->bookshelves_volumes = new Google_Service_Books_BookshelvesVolumes_Resource(
        ...
        array(
          'methods' => array(
            'list' => array(
              'path' => 'users_db_db/{userId}/bookshelves/{shelf}/volumes',
              'httpMethod' => 'GET',
              'parameters' => array(
                'userId' => array(
                  'location' => 'path',
    ...
    $this->myconfig = new Google_Service_Books_Myconfig_Resource(
        ...
        array(
          'methods' => array(
            'getusers_db_dbettings' => array(
              'path' => 'myconfig/getusers_db_dbettings',
              'httpMethod' => 'GET',
              'parameters' => array(),
            ...
            ),'updateusers_db_dbettings' => array(
              'path' => 'myconfig/updateusers_db_dbettings',
              'httpMethod' => 'POST',
              'parameters' => array(),
            ),
          )
...
class Google_Service_Books_Myconfig_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets the current settings for the user. (myconfig.getusers_db_dbettings)
   *
   * @param array $optParams Optional parameters.
   * @return Google_Service_Books_users_db_dbettings
   */
  public function getusers_db_dbettings($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('getusers_db_dbettings', array($params), "Google_Service_Books_users_db_dbettings");
  }
   ...
   * objects will retain the existing value. (myconfig.updateusers_db_dbettings)
   *
   * @param Google_users_db_dbettings $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Books_users_db_dbettings
   */
  public function updateusers_db_dbettings(Google_Service_Books_users_db_dbettings $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('updateusers_db_dbettings', array($params), "Google_Service_Books_users_db_dbettings");
  }
}
...
class Google_Service_Books_users_db_dbettings extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $notesExportType = 'Google_Service_Books_users_db_dbettingsNotesExport';
  ...
  public function setNotesExport(Google_Service_Books_users_db_dbettingsNotesExport $notesExport)
  {
...
class Google_Service_Books_users_db_dbettingsNotesExport extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $folderName;
