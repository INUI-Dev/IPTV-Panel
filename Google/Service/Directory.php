 ...
 * such as users_db_db and groups, administrative notifications, security features,
 * and more.</p>
 *
 * <p>
...
class Google_Service_Directory extends Google_Service
{
  ...
  /** View and manage the provisioning of users_db_db on your domain. */
  ...
  /** View users_db_db on your domain. */
  const ADMIN_DIRECTORY_USER_READONLY =
      "https://www.googleapis.com/auth/admin.directory.user.readonly";
  /** Manage data access permissions for users_db_db on your domain. */
  const ADMIN_DIRECTORY_USER_SECURITY =
      "https://www.googleapis.com/auth/admin.directory.user.security";
  /** View and manage the provisioning of user schemas on your domain. */
  const ADMIN_DIRECTORY_users_db_dbCHEMA =
      "https://www.googleapis.com/auth/admin.directory.users_db_dbchema";
  /** View user schemas on your domain. */
  const ADMIN_DIRECTORY_users_db_dbCHEMA_READONLY =
      "https://www.googleapis.com/auth/admin.directory.users_db_dbchema.readonly";
  ...
  public $tokens;
  public $users_db_db;
  public $users_db_db_aliases;
  public $users_db_db_photos;
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->asps = new Google_Service_Directory_Asps_Resource(
        ...
        array(
          'methods' => array(
            'delete' => array(
              'path' => 'users_db_db/{userKey}/asps/{codeId}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
    ...
    $this->tokens = new Google_Service_Directory_Tokens_Resource(
        ...
        array(
          'methods' => array(
            'delete' => array(
              'path' => 'users_db_db/{userKey}/tokens/{clientId}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
              ...
              'path' => 'users_db_db/{userKey}/tokens',
              'httpMethod' => 'GET',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
    ...
    $this->users_db_db = new Google_Service_Directory_users_db_db_Resource(
        $this,
        $this->serviceName,
        'users_db_db',
        array(
          'methods' => array(
            'delete' => array(
              ...
              'path' => 'users_db_db/{userKey}/makeAdmin',
              'httpMethod' => 'POST',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
              ...
              'path' => 'users_db_db/{userKey}/undelete',
              'httpMethod' => 'POST',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
    ...
    $this->users_db_db_aliases = new Google_Service_Directory_users_db_dbAliases_Resource(
        $this,
        $this->serviceName,
        'aliases',
        array(
          'methods' => array(
            'delete' => array(
              'path' => 'users_db_db/{userKey}/aliases/{alias}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
              ...
              'path' => 'users_db_db/{userKey}/aliases',
              'httpMethod' => 'POST',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
              ...
              'path' => 'users_db_db/{userKey}/aliases/watch',
              'httpMethod' => 'POST',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
    ...
    $this->users_db_db_photos = new Google_Service_Directory_users_db_dbPhotos_Resource(
        $this,
        $this->serviceName,
        'photos',
        array(
          'methods' => array(
            'delete' => array(
              'path' => 'users_db_db/{userKey}/photos/thumbnail',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
    ...
    $this->verificationCodes = new Google_Service_Directory_VerificationCodes_Resource(
        ...
        array(
          'methods' => array(
            'generate' => array(
              'path' => 'users_db_db/{userKey}/verificationCodes/generate',
              'httpMethod' => 'POST',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
              ...
              'path' => 'users_db_db/{userKey}/verificationCodes/invalidate',
              'httpMethod' => 'POST',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
              ...
              'path' => 'users_db_db/{userKey}/verificationCodes',
              'httpMethod' => 'GET',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
...
class Google_Service_Directory_Notifications_Resource extends Google_Service_Resource
{
   ...
   * customerId is also returned as part of the users_db_db resource.
...
/**
 * The "users_db_db" collection of methods.
 * Typical usage is:
 *  <code>
 *   $adminService = new Google_Service_Directory(...);
 *   $users_db_db = $adminService->users_db_db;
 *  </code>
 */
class Google_Service_Directory_users_db_db_Resource extends Google_Service_Resource
{

  /**
   * Delete user (users_db_db.delete)
   *
  ...
  /**
   * create user. (users_db_db.insert)
   *
  ...
  /**
   * Retrieve either deleted users_db_db or all users_db_db in a domain (paginated)
   * (users_db_db.listusers_db_db)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param string customer Immutable id of the Google Apps account. In case
   * of multi-domain, to fetch all users_db_db for a customer, fill this field instead
   * of domain.
   * @opt_param string orderBy Column to use for sorting results
   * @opt_param string domain Name of the domain. Fill this field to get users_db_db
   * from only this domain. To return all users_db_db in a multi-domain fill customer
   * field instead.
   * @opt_param string projection What subset of fields to fetch for this user.
   * @opt_param string showDeleted If set to true retrieves the list of deleted
   * users_db_db. Default is false
   * @opt_param string customFieldMask Comma-separated list of schema names. All
   * fields from these schemas are fetched. This should only be set when
   * projection=custom.
   ...
   * sdk/directory/v1/guides/search-users_db_db
   * @opt_param string viewType Whether to fetch the ADMIN_VIEW or DOMAIN_PUBLIC
   * view of the user.
   * @opt_param string event Event on which subscription is intended (if
   * subscribing)
   * @return Google_Service_Directory_users_db_db
   */
  public function listusers_db_db($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Directory_users_db_db");
  }

  /**
   * change admin status of a user (users_db_db.makeAdmin)
   *
  ...
  /**
   * update user. This method supports patch semantics. (users_db_db.patch)
   *
  ...
  /**
   * Undelete a deleted user (users_db_db.undelete)
   *
  ...
  /**
   * update user (users_db_db.update)
   *
   * @param string $userKey Email or immutable Id of the user. If Id, it should
   * match with id of user object
   * @param Google_User $postBody
  ...
  /**
   * Watch for changes in users_db_db list (users_db_db.watch)
   *
   * @param Google_Channel $postBody
   * @param array $optParams Optional parameters.
   *
 ...
 *  </code>
 */
class Google_Service_Directory_users_db_dbAliases_Resource extends Google_Service_Resource
{
  ...
  /**
   * List all aliases for a user (aliases.listusers_db_dbAliases)
   *
   * @param string $userKey Email or immutable Id of the user
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Google_Service_Directory_Aliases
   */
  public function listusers_db_dbAliases($userKey, $optParams = array())
  {
    $params = array('userKey' => $userKey);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Directory_Aliases");
 ...
 *  </code>
 */
class Google_Service_Directory_users_db_dbPhotos_Resource extends Google_Service_Resource
{
...
{
  protected $collection_key = 'recentusers_db_db';
  protected $internal_gapi_mappings = array(
  );
  ...
  protected $recentusers_db_dbType = 'Google_Service_Directory_ChromeOsDeviceRecentusers_db_db';
  protected $recentusers_db_dbDataType = 'array';
  public $serialNumber;
  public $status;
  ...
  public function setRecentusers_db_db($recentusers_db_db)
  {
    $this->recentusers_db_db = $recentusers_db_db;
  }
  public function getRecentusers_db_db()
  {
    return $this->recentusers_db_db;
  }
...
class Google_Service_Directory_ChromeOsDeviceRecentusers_db_db extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $email;
...
class Google_Service_Directory_users_db_db extends Google_Collection
{
  protected $collection_key = 'users_db_db';
  protected $internal_gapi_mappings = array(
  ...
  public $nextPageToken;
  public $triggerEvent;
  protected $users_db_dbType = 'Google_Service_Directory_User';
  protected $users_db_dbDataType = 'array';
  ...
  public function setusers_db_db($users_db_db)
  {
    $this->users_db_db = $users_db_db;
  }
  public function getusers_db_db()
  {
    return $this->users_db_db;
  }
}
