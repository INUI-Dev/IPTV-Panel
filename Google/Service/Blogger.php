  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->blogUserInfos = new Google_Service_Blogger_BlogUserInfos_Resource(
        ...
        array(
          'methods' => array(
            'get' => array(
              'path' => 'users_db_db/{userId}/blogs/{blogId}',
              'httpMethod' => 'GET',
              'parameters' => array(
                'userId' => array(
                  'location' => 'path',
    ...
    $this->postUserInfos = new Google_Service_Blogger_PostUserInfos_Resource(
        ...
        array(
          'methods' => array(
            'get' => array(
              'path' => 'users_db_db/{userId}/blogs/{blogId}/posts/{postId}',
              'httpMethod' => 'GET',
              'parameters' => array(
                'userId' => array(
                  'location' => 'path',
              ...
              'path' => 'users_db_db/{userId}/blogs/{blogId}/posts',
              'httpMethod' => 'GET',
              'parameters' => array(
                'userId' => array(
                  'location' => 'path',
    ...
    $this->users_db_db = new Google_Service_Blogger_users_db_db_Resource(
        $this,
        $this->serviceName,
        'users_db_db',
        array(
 ...
 *  <code>
 *   $bloggerService = new Google_Service_Blogger(...);
 *   $users_db_db = $bloggerService->users_db_db;
 *  </code>
 */
class Google_Service_Blogger_users_db_db_Resource extends Google_Service_Resource
{

  /**
   * Gets one user by ID. (users_db_db.get)
   *
