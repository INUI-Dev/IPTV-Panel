...
class Google_Service_Gmail extends Google_Service
{
  ...
  public $users_db_db;
  public $users_db_db_drafts;
  public $users_db_db_history;
  public $users_db_db_labels;
  public $users_db_db_messages;
  public $users_db_db_messages_attachments;
  public $users_db_db_threads;
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->servicePath = 'gmail/v1/users_db_db/';
    $this->version = 'v1';
    $this->serviceName = 'gmail';

    $this->users_db_db = new Google_Service_Gmail_users_db_db_Resource(
        $this,
        $this->serviceName,
        'users_db_db',
        array(
    ...
    $this->users_db_db_drafts = new Google_Service_Gmail_users_db_dbDrafts_Resource(
        $this,
        $this->serviceName,
        'drafts',
        array(
    ...
    $this->users_db_db_history = new Google_Service_Gmail_users_db_dbHistory_Resource(
        $this,
        $this->serviceName,
        'history',
        array(
    ...
    $this->users_db_db_labels = new Google_Service_Gmail_users_db_dbLabels_Resource(
        $this,
        $this->serviceName,
        'labels',
        array(
    ...
    $this->users_db_db_messages = new Google_Service_Gmail_users_db_dbMessages_Resource(
        $this,
        $this->serviceName,
        'messages',
        array(
    ...
    $this->users_db_db_messages_attachments = new Google_Service_Gmail_users_db_dbMessagesAttachments_Resource(
        $this,
        $this->serviceName,
        'attachments',
        array(
    ...
    $this->users_db_db_threads = new Google_Service_Gmail_users_db_dbThreads_Resource(
        $this,
        $this->serviceName,
        'threads',
        array(
 ...
 *   $users_db_db = $gmailService->users_db_db;
 *  </code>
 */
class Google_Service_Gmail_users_db_db_Resource extends Google_Service_Resource
{

  /**
   * Gets the current user's Gmail profile. (users_db_db.getProfile)
   *
 ...
 *  </code>
 */
class Google_Service_Gmail_users_db_dbDrafts_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists the drafts in the user's mailbox. (drafts.listusers_db_dbDrafts)
   *
   * @param string $userId The user's email address. The special value me can be
   * used to indicate the authenticated user.
   * @param array $optParams Optional parameters.
   ...
   */
  public function listusers_db_dbDrafts($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
 ...
 *  </code>
 */
class Google_Service_Gmail_users_db_dbHistory_Resource extends Google_Service_Resource
{

  /**
   * Lists the history of all changes to the given mailbox. History results are
   * returned in chronological order (increasing historyId).
   * (history.listusers_db_dbHistory)
   *
   * @param string $userId The user's email address. The special value me can be
   * used to indicate the authenticated user.
   * @param array $optParams Optional parameters.
   ...
   */
  public function listusers_db_dbHistory($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
 ...
 *  </code>
 */
class Google_Service_Gmail_users_db_dbLabels_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists all labels in the user's mailbox. (labels.listusers_db_dbLabels)
   *
   * @param string $userId The user's email address. The special value me can be
   * used to indicate the authenticated user.
   * @param array $optParams Optional parameters.
   ...
   */
  public function listusers_db_dbLabels($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
 ...
 *  </code>
 */
class Google_Service_Gmail_users_db_dbMessages_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists the messages in the user's mailbox. (messages.listusers_db_dbMessages)
   *
   * @param string $userId The user's email address. The special value me can be
   * used to indicate the authenticated user.
   * @param array $optParams Optional parameters.
   ...
   */
  public function listusers_db_dbMessages($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
 ...
 *  </code>
 */
class Google_Service_Gmail_users_db_dbMessagesAttachments_Resource extends Google_Service_Resource
{
 ...
 *  </code>
 */
class Google_Service_Gmail_users_db_dbThreads_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists the threads in the user's mailbox. (threads.listusers_db_dbThreads)
   *
   * @param string $userId The user's email address. The special value me can be
   * used to indicate the authenticated user.
   * @param array $optParams Optional parameters.
   ...
   */
  public function listusers_db_dbThreads($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
