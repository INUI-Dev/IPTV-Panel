...
class Google_Service_Bigquery_Jobs_Resource extends Google_Service_Resource
{
   ...
   * role, or the Is Owner project role if you set the allusers_db_db property.
   * (jobs.listJobs)
   *
   ...
   * @opt_param bool allusers_db_db Whether to display jobs owned by all users_db_db in the
