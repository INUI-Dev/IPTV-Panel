 ...
 * usage, collaboration, security and risk for their users_db_db.</p>
 *
 * <p>
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->activities = new Google_Service_Reports_Activities_Resource(
        ...
        array(
          'methods' => array(
            'list' => array(
              'path' => 'activity/users_db_db/{userKey}/applications/{applicationName}',
              'httpMethod' => 'GET',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
              ...
              'path' => 'activity/users_db_db/{userKey}/applications/{applicationName}/watch',
              'httpMethod' => 'POST',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
    ...
    $this->userUsageReport = new Google_Service_Reports_UserUsageReport_Resource(
        ...
        array(
          'methods' => array(
            'get' => array(
              'path' => 'usage/users_db_db/{userKey}/dates/{date}',
              'httpMethod' => 'GET',
              'parameters' => array(
                'userKey' => array(
                  'location' => 'path',
...
class Google_Service_Reports_Activities_Resource extends Google_Service_Resource
{
   ...
   * returns usageReports for all users_db_db.
...
class Google_Service_Reports_UserUsageReport_Resource extends Google_Service_Resource
{
   ...
   * of users_db_db. (userUsageReport.get)
   *
   * @param string $userKey Represents the profile id or the user email for which
