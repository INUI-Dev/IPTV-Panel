          ...
          <div class="row">
            <div class="col-md-12">
              <div class="grid simple ">
                ...
                <div class="grid-body no-border"><h2>Follow this video for ministra and stalkertv Apps</h2><script type="text/javascript" src="https://content.jwplatform.com/libraries/SaC5BzE9.js"></script>
...
<script type='text/javascript'>
	...
	primary: "html5",
		...
		height:'350'
                  ...
                  {if isset($deleted)}<h3 class="text-success ">Success : Line Deleted</h3>{/if}
                  {if $lines.0.is_empty == 'true'}
...
<table class="table no-more-tables">
                                  <thead>
                                    <tr>
                                      ...
                                      <th width="164">Last Watched</th>
                                      <th width="121">Expires</th>
                                      <th width="144">Delete </th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                  </tbody>
                                  ...
                                  <tr>
                                    <td>{if $items.expires == 'Expired'}
                                      <div class="red-circle"></div><br>
                                      <span class="red1">Expired</span>{else}
                                      <div class="green-circle"></div><br>
                                    ...
                                    <td>{$items.expires}</td>
                                    <td>{if $items.expires =='Expired'}<a href="?delete=true&id={$items.id}&pname=lines">Delete  </a> - <a href="?pname=renew&id={$items.id}">Renew</a>{else}No Actions{/if}</td>
                                  </tr> 
                                  
                                  <tr>
                                    <td colspan="2" height="10px"><p align="right" style="padding-right:5px;"><strong>M3U Line</strong></p></td>
                                    <td colspan="6"><a href="http://{$smarty.server.HTTP_HOST}{$site_root}/iptv.php?user={$items.user}&pass={$items.pass}&list={$items.display}" target="_blank">http://{$smarty.server.HTTP_HOST}{$site_root}/iptv.php?user={$items.user}&amp;pass={$items.pass}&amp;list={$items.display}</a></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2"><p align="right" style="padding-right:5px;"><strong>MinistraTV  Portal url</strong></p></td>
                                    <td colspan="6"><a href="{$ministra}/{$ministra_dir}">{$ministra}/{$ministra_dir}</a></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2"><p align="right" style="padding-right:5px;"><strong>App Portal Username</strong></td>
                                    <td colspan="6"><strong>{$items.user} </strong></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2"><p align="right" style="padding-right:5px;"><strong>App Portal Password</strong></td>
                                    <td colspan="6"><p><strong>{$items.pass}</strong></p></td>
                </tr><tr>
                  <td colspan="8"><hr/></td>
                  </tr>
                                  {/foreach}
