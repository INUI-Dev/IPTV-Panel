...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>in2iptv.com Admin Palel</title>
      ...
      <div class="page-content">
        ...
        <div class="content">
          <ul class="breadcrumb">
            ...
            <li><a href="#" class="active">Credits</a>
            </li>
              ...
              <div class="grid simple ">
                ...
                <div class="grid-body no-border">
                  <table class="table no-more-tables">
                    <thead>
                      <tr>
                        <th style="width:20%">Uername</th>
                        <th style="width:20%">Credits remaining</th>
                        <th style="width:35%">Total Credits purchase</th>
                        <th style="width:35%">Buy more credits</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td class="v-align-middle"><strong>{$users_db.0.uname}</strong></td>
                        <td class="v-align-middle">{$users_db.0.credits}</td>
                        <td class="v-align-middle">{$users_db.0.purchased}</td>
                        <td><span class="muted"><a href="?pname=add-credits">Buy Credits</a></span> </td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div class="grid simple ">
                ...
                <div class="grid-body no-border">
                  <table class="table no-more-tables">
                    ...
                    <tbody>
                      {foreach $credits as $items}<tr>
                        <td class="v-align-middle"><strong>{$items.cur_sign}({$items.cur_code}){$items.price}</strong></td>
                        <td class="v-align-middle">{$users_db.0.credits}</td>
                        <td><span class="muted"><a href="../buy-credits.php?id={$items.id}" target="_blank">Buy These credits</a></span> </td>
                      </tr>{/foreach}
                    </tbody>
                  </table>
                </div>
