...
<h2>No lines added</h2>{else}<table class="table no-more-tables">
                                  <thead>
                                    <tr>
                                      <th>Name</th>
                                      <th>Username</th>
                                  ...
                                  <tr>
                                    ...
                                    <td>{$items.expires}</td>
                                    <td>{if $items.expires =='Expired'}<a href="?delete=true&id={$items.id}&pname=lines">Delete</a>{else}No Actions{/if}</td>
                                  </tr> 
                                  
                                  <tr>
                                    <td><strong>Line</strong></td>
                                    <td colspan="5"><a href="http://{$smarty.server.HTTP_HOST}{$site_root}/iptv.m3u?user={$items.user}&pass={$items.pass}&list={$items.display}" target="_blank">http://{$smarty.server.HTTP_HOST}{$site_root}/iptv.m3u?user={$items.user}&amp;pass={$items.pass}&amp;list={$items.display}</a></td>
                </tr><tr>
                                    <td colspan="6"><hr/></td>
                                  </tr>
                                  {/foreach}
