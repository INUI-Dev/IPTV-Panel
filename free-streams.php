...
$content['streams']= $db1->db_query("SELECT * FROM iptv WHERE sub='all' ORDER BY id Desc",array (
    "name",'id','m3u_name'
),1000000,0);
if(isset($content['loginaction'])){

$smarty->assign('loginaction',$content['loginaction']);
}
$smarty->assign('streams',$content['streams']);
$smarty->assign('page_title',$title['free']);
...
$smarty->display('free-streams.tpl'); ?>
