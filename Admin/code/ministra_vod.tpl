    ...
    <ul class="nav navbar-nav-custom">
                  ...
                  <div id="page-content">
                          ...
                          <div class="block-title">
                            ...
                            <div class="panel-body">
                                ...
                                {else} <form name="form1" method="post" action="">
                                   ...
                                   <option value="all">All</option>   {foreach $iptv as $items}<option value="{$items.id}">{$items.name} </option>{/foreach}</select>
                                       <br />
                    ...
                    <footer class="clearfix">
                        ...
                        <div class="pull-left">
                            </span> &copy; <a href="http://in2iptv.com" target="_blank">In2iptv</a>
                        </div>
                    </footer>
                    <!-- END Footer -->
                </div>
